...
all_constraints([S2C,S2R,S3C,S3R,S4C,S4R,S5C,S5R,Z,Col,Row]) :-
	...
	write('Adding constraint "'), write('Z_I = 3 <=> (Col_I - 2 =< S3C /\\ S3C =< Col_I /\\ Row_I - 2 =< S3R /\\ S3R =< Row_I) "'), write(' for values:'), nl,
	the_constraint2(Z,Col,Row,S3C,S3C,S3R,S3R),
	write('Adding constraint "'), write('Z_I = 4 <=> (Col_I - 3 =< S4C /\\ S4C =< Col_I /\\ Row_I - 3 =< S4R /\\ S4R =< Row_I) "'), write(' for values:'), nl,
	the_constraint3(Z,Col,Row,S4C,S4C,S4R,S4R),
	write('Adding constraint "'), write('Z_I = 5 <=> (Col_I - 4 =< S5C /\\ S5C =< Col_I /\\ Row_I - 4 =< S5R /\\ S5R =< Row_I) "'), write(' for values:'), nl,
	the_constraint4(Z,Col,Row,S5C,S5C,S5R,S5R),
	write('Adding constraint "'), write('Col_I = I mod 9 "'), write(' for values:'), nl,
	the_constraint5(Col),
	write('Adding constraint "'), write('Row_I = ( I / 9 )"'), write(' for values:'), nl,
	the_constraint6(Row).
